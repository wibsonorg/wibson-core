...
contract TestWibcoin {
  ...
  function testTotalSupply() public {
    uint256 expected = 9000000000000000000;

    Assert.equal(deployedWibcoin.totalSupply(), expected, "Deployed Wibcoin total supply should be 9 quintrillion WIB");
    Assert.equal(newWibcoin.totalSupply(), expected, "New Wibcoin total supply should be 9 quintrillion WIB");
  }

  function testBalanceOf() public {
    uint256 expected = 9000000000;

    Assert.equal(deployedWibcoin.balanceOf(msg.sender), expected, "Deployed Wibcoin owner should have 9 billion WIB initially");
    Assert.equal(newWibcoin.balanceOf(msg.sender), expected, "New Wibcoin owner should have 9 billion WIB initially");
  }
  ...
  function testAllowance() public {
    ...
    deployedWibcoin.approve(spender, expectedRemaining);
    newWibcoin.approve(spender, expectedRemaining);
