...
contract TestWibcoin {
  ...
  function testApprove() public {
    ...
    Assert.equal(deployedWibcoin.approve(expectedReceiverBalance, allowance), expectedApproveReturn, "Deployed Wibcoin should approve a transaction ");
    Assert.equal(newWibcoin.approve(expectedReceiverBalance, allowance), expectedApproveReturn, "New Wibcoin should approve a transaction ");
  }
  ...
  function testAllowance() public {
    ...
    Assert.equal(deployedWibcoin.approve(owner, spender), expectedRemaining, "Deployed Wibcoin should return remaining allowance");
    Assert.equal(newWibcoin.approve(owner, spender), expectedRemaining, "New Wibcoin should return remaining allowance");
  }
